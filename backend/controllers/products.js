...
const createProduct = async (req, res, next) => {
    ...
    const { seller, name, description, price, category, quantity, isVisible } = req.body;
    try {
        const newProduct = new Product({ seller, name, description, price, category, quantity, isVisible });
